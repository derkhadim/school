...
class MatieresControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create matiere" do
    assert_difference('Matiere.count') do
      post matieres_url, params: { matiere: { anglais: @matiere.anglais, maths: @matiere.maths, pc: @matiere.pc, student_id: @matiere.student_id, svt: @matiere.svt } }
    end
  ...
  test "should update matiere" do
    patch matiere_url(@matiere), params: { matiere: { anglais: @matiere.anglais, maths: @matiere.maths, pc: @matiere.pc, student_id: @matiere.student_id, svt: @matiere.svt } }
